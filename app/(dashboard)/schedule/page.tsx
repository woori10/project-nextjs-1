  ...
  return (
    <div className="h-full p-4">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-xl font-semibold uppercase">Jadwal Kuliah</h1>
        </div>
          ...
          <table className="min-w-[700px] w-full border border-gray-300 table-fixed bg-white">
            <thead className="text-center border-b text-sm border-gray-300">
              <tr>
                ...
                <th className="w-1/4 py-4 px-3 font-semibold uppercase">Ruangan</th>
                <th className="w-1/4 py-4 px-3 font-semibold uppercase">Kelas</th>
                <th className="w-1/4 py-4 px-3 font-semibold uppercase">Hari</th>
                <th className="w-1/4 py-4 px-3 font-semibold uppercase">Pukul</th>
              ...
              {loading ? (
                ...
                schedules.map((item) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-3">{item.ruangan}</td>
                    <td className="py-4 px-3">
                      <KelasBadge kelas={item.kelas} />
                    </td>
                    <td className="py-4 px-3">{item.hari}</td>
                    <td className="py-4 px-3">{item.mulai} - {item.selesai}</td>
